            ...
            for j in range(len(chemin_crit)-1):
                if Gv.MA[chemin_crit[i]][chemin_crit[j]]==1:
                    ...
                    for n in range(len(liste_chemin_crit)):
                        print(i, chemin_crit[i], added, liste_chemin_crit[n], liste_chemin_crit[n][len(liste_chemin_crit[n])-1-added])
                        if chemin_crit[i] == liste_chemin_crit[n][len(liste_chemin_crit[n])-1-added]:
                            ...
                            if added == 0:
                                liste_chemin_crit.append(copy.deepcopy(liste_chemin_crit[n][:len(liste_chemin_crit[n])-added]))
